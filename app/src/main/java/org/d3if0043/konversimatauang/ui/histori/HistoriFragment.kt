...
import org.d3if0043.konversimatauang.databinding.FragmentHistoriBinding
import org.d3if0043.konversimatauang.db.ConvertionDb

class HistoriFragment : Fragment() {

    private val viewModel: HistoriViewModel by lazy {
        val db = ConvertionDb.getInstance(requireContext())
